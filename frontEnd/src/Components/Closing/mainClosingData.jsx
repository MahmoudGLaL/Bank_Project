...
const MainClosingData = ({ filteredClose }) => {
        ...
        body {
            font-family: 'Tajawal', sans-serif;
                ...
                <div>
                    ...
                    <div style="display: flex; justify-content: center; align-items: center;"> <h3 style= " padding: 0.8rem 0.8rem; border: 0.5px dashed black ">تقرير خزنة ال${filteredClose.treasuryName} ل شهر ${filteredClose.date}</h3></div>
                        ...
                        <table dir="rtl" style="width: 100%; border: 1px solid #e2e8f0; border-collapse: collapse; padding: 1rem; margin-top: 3.5rem;">
                            <tbody>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    ...
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="name">${parseFloat(filteredClose?.totalPaid) + parseFloat(filteredClose?.totalNotPaid) + parseFloat(filteredClose?.totalCanceld)}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;"> إجمالي التحصيلات المدفوعه </td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="nationalId">${filteredClose?.totalPaid}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;">  إجمالي التحصيلات الغير مدفوعه </td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="phoneNumber">${filteredClose?.totalNotPaid}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;">  إجمالي التحصيلات الملغيه </td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="phoneNumber">${filteredClose?.totalCanceld}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;"> عدد المعاملات </td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="emplyee">${parseInt(filteredClose?.paidCount) + parseInt(filteredClose?.notpaidCount) + parseInt(filteredClose?.canceldCount)}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;"> عدد المعاملات المدفوعه</td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="emplyee">${filteredClose?.paidCount}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;"> عدد المعاملات الغير مدفوعه</td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="paymentType">${filteredClose?.notpaidCount}</td>
                                </tr>
                                <tr style="border-bottom: 1px solid #e2e8f0; text-align: center;">
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;"> عدد الألغاءات</td>
                                    <td style="border: 1px solid #e2e8f0; padding: 0.5rem;" id="paymentType">${filteredClose?.canceldCount}</td>
                                </tr>
            ...
            else if(filteredClose?.date == formattedDate)
            {
                content = `<div>
                <style>
            /* Import the font if it's a web font */
            ...
            body {
                font-family: 'Tajawal', sans-serif;
                    ...
                    <div>
                        ...
                        <div style="display: flex; justify-content: center; align-items: center;"> <h3 style= " padding: 0.8rem 0.8rem; border: 0.5px dashed black ">  تقرير خزنة ال${filteredClose.treasuryName} ل يوم ${filteredClose.date}</h3></div>
        ...
        body {
            font-family: 'Tajawal', sans-serif;
                ...
                <div>
                    ...
                    <div style="display: flex; justify-content: center; align-items: center;"> <h3 style= " padding: 0.8rem 0.8rem; border: 0.5px dashed black ">تقرير خزنة ال ${filteredClose.treasuryName}</h3></div>
            ...
            <div dir='rtl' className='grid grid-cols-9  mx-5 px-12'>
                <div className='col-span-3'>
                    <div className='bg-white w-[80%] border-[0.1px] my-[20px] pt-1 pb-5 '>
                        ...
                        <p className='px-5 text-[30px]'> {filteredClose && <> {parseFloat(filteredClose?.totalPaid) + parseFloat(filteredClose?.totalNotPaid) + parseFloat(filteredClose?.totalCanceld)}</>}    EGP</p>
                        <small className='px-5'> {filteredClose && <>{parseInt(filteredClose?.paidCount) + parseInt(filteredClose?.notpaidCount) + parseInt(filteredClose?.canceldCount)}</>}   أمر  </small>
                ...
                <div className='col-span-3'>
                    <div className='bg-white w-[80%] border-[0.1px] my-[20px] pt-1 pb-5 '>
                        ...
                        <p className='px-5 text-[30px]'>{filteredClose?.totalPaid} EGP</p>
                        <small className='px-5'>{filteredClose?.paidCount} معاملة</small>
                ...
                <div className='col-span-3'>
                    <div className='bg-white w-[80%] border-[0.1px] my-[20px] pt-1 pb-5 '>
                        ...
                        <p className='px-5 text-[30px]'>{filteredClose?.totalNotPaid} EGP</p>
                        <small className='px-5'>{filteredClose?.notpaidCount} معاملة</small>
    ...
    <small className='px-5'>0 معاملة</small>
                ...
                <div className='col-span-3'>
                    <div className='bg-white w-[80%] border-[0.1px] my-[20px] pt-1 pb-5 '>
                        ...
                        <p className='px-5 text-[30px]'>{filteredClose?.totalRefund} EGP</p>
                        <small className='px-5'> {filteredClose?.refundCount} معاملة</small>
                ...
                <div className='col-span-3'>
                    <div className='bg-white w-[80%] border-[0.1px] my-[20px] pt-1 pb-5 '>
                        ...
                        <p className='px-5 text-[30px]'>{filteredClose?.totalCanceld} EGP</p>
                        <small className='px-5'> {filteredClose?.canceldCount} معاملة</small>
